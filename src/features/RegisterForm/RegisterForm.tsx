                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormMessage className={`${errors.surname ? 'min-h-5' : ''}`}>{errors.name?.message && ''} </FormMessage>
                            </FormItem>
                        )}
                    />
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormMessage className={`${errors.name ? 'min-h-5' : ''}`}>{errors.surname?.message && ''} </FormMessage>
                            </FormItem>
                        )}
                    />
                </div>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormMessage className={`${errors.letter ? 'min-h-5' : ''}`}>{errors.form?.message && ''} </FormMessage>
                            </FormItem>
                        )}
                    />
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormMessage className={`${errors.letter?.message ? 'min-h-5' : ''}`}>{errors.letter?.message && ''} </FormMessage>
                            </FormItem>
                        )}
                    />
                </div>
